...
public class BlockEventListener implements Listener {
    ...
    public void onBreak(@NotNull BlockBreakEvent event) {
        final ItemStack mainHand = event.getPlayer()
            .getInventory()
            .getItemInMainHand();
        final ItemStack offHand = event.getPlayer()
            .getInventory()
            .getItemInOffHand();
    ...
    private <T extends BlockEvent> void handleItem(@NotNull Class<T> eventClass, @NotNull T event, @NotNull ItemStack stack) {
