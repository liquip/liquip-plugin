# The Liquip Plugin
[![Gradle Package](https://github.com/liquip/liquip-plugin/actions/workflows/gradle-publish.yml/badge.svg?branch=main)](https://github.com/liquip/liquip-plugin/actions/workflows/gradle-publish.yml)
